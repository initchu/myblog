...
# <font style="color:rgb(0, 0, 0);">父 goroutine 退出，如何使得子 goroutine 也退出？</font>
父子协程的退出分为两种情况：
...
`<font style="color:rgb(77, 77, 77);">context</font>`<font style="color:rgb(77, 77, 77);">主要用于父子任务之间的同步取消信号，本质上是一种协程调度的方式。</font>
...
> 更新: 2022-11-14 00:49:39  
> 原文: <https://www.yuque.com/xiaoshan_wgo/codingnotes/kygqgx>