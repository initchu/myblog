...
其中，iface 结构体中有指向原始数据的指针 data，不过更重要的是 runtime.itab 类型的 tab 字段。
...
> 更新: 2022-04-09 19:14:08  
> 原文: <https://www.yuque.com/xiaoshan_wgo/codingnotes/gvxald>