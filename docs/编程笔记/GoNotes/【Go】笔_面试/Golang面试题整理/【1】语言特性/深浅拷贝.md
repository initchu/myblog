...
<font style="color:rgb(0, 0, 0);">问法：go 深拷贝发生在什么情况下？/ 什么是深拷贝，浅拷贝？/ 切片的深拷贝是怎么做的？</font>

<font style="color:rgb(0, 0, 0);">题目来源：映客，腾讯，北京合链</font>
...
<font style="color:rgb(51, 51, 51);">在go语言中值类型赋值都是深拷贝，引用类型一般都是浅拷贝：</font>
...
### 怎么进行（切片的）深拷贝？
<font style="color:rgb(77, 77, 77);">可以使用 copy() 函数来进行深拷贝，copy 不会进行扩容，当要复制的 slice 比原 slice 要大的时候，只会移除多余的。</font>
...
> <font style="color:rgb(36, 41, 46);">Go 中切片扩容的策略：</font>
>
...
> 更新: 2022-09-13 15:16:50  
> 原文: <https://www.yuque.com/xiaoshan_wgo/codingnotes/fkbio4>